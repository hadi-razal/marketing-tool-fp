...
type Tab = 'overview' | 'contacts' | 'exhibitors' | 'photos' | 'notes';
    ...
    return (
        <>
            ...
            <div className="flex h-full flex-col bg-zinc-50/50">
                ...
                <div className="shrink-0 bg-zinc-900">
                    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="flex items-center gap-4 pb-6 sm:gap-5 sm:pb-8">
                            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-orange-400 to-orange-600 text-lg font-bold text-white sm:h-16 sm:w-16 sm:text-xl">
                                {initials}
                            </div>
                            <div className="min-w-0">
                                {eventType && (
                ...
                <div className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8 flex flex-col min-h-full">
                    ...
                    {activeTab === 'overview' && (
                        <div className="space-y-6">
                            ...
                            {/* Links */}
                            {(exhibitorListLink || floorplanLink) && (
                                <div className="rounded-lg border border-zinc-200 bg-white">
                                    <div className="border-b border-zinc-100 px-5 py-3">
                                    ...
                                    <div className="grid grid-cols-1 gap-2 p-3 sm:grid-cols-2">
                                        {exhibitorListLink && (
                                            <a
                                                href={exhibitorListLink}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="group flex items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-50"
                                            >
                                                <Users className="h-4 w-4 text-zinc-400" />
                                                Exhibitor List
                                                <ExternalLink className="ml-auto h-3.5 w-3.5 text-zinc-300 transition-colors group-hover:text-zinc-500" />
                                            </a>
                                        )}
                                        {floorplanLink && (
                                            <a
                            ...
                            {note && (
                                <div className="rounded-lg border border-zinc-200 bg-white">
                                    ...
                                    <div className="px-5 py-4">
                                        <p className="whitespace-pre-wrap text-sm leading-relaxed text-zinc-600">{note}</p>
                                    </div>
                                </div>
                            )}
                        </div>
                    ...
                    {activeTab === 'contacts' && (
                        <div className="flex flex-1 flex-col gap-5">
                            ...
                            <div className="flex flex-1 items-center justify-center rounded-lg border border-zinc-200 bg-white">
                                <EmptyState
                                    icon={<UserCircle2 className="h-8 w-8 text-zinc-400" />}
                                    title="No contacts yet"
                                    description="Add organisers, key people, and accounts associated with this show."
                                />
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === 'exhibitors' && (
                        <div className="flex flex-1 flex-col min-h-0 bg-white">
                            {/* Toolbar — centered */}
                            <div className="shrink-0 mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
                            ...
                            {(() => {
                                ...
                                return (
                                    <div className="flex-1 min-h-0 overflow-y-auto border-t border-zinc-100">
                                        <table className="w-full text-left text-sm">
                                            ...
                                            <tbody className="divide-y divide-zinc-50">
                                                {sorted.length > 0 ? (
                                                    sorted.map((ex, i) => (
                                                        <tr key={i} className="transition-colors hover:bg-zinc-50/80">
                                                            <td className="whitespace-nowrap px-5 py-3 font-medium text-zinc-900">{ex.company}</td>
                                                            ...
                                                            <td className="whitespace-nowrap px-5 py-3 text-right">
                                                                <button className="text-xs font-semibold text-orange-600 transition-colors hover:text-orange-700">
                                                                    View More
                                                                </button>
                                                            </td>
                                                        </tr>
                ...
                <div className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8 flex flex-col min-h-full">
                    ...
                    {activeTab === 'photos' && (
                        <div className="flex flex-1 flex-col gap-5">
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                <h2 className="text-lg font-semibold text-zinc-900">Photos & Floorplans</h2>
                                <Button size="sm" variant="primary" leftIcon={<Plus className="h-4 w-4" />} onClick={() => toast.info('Coming soon')}>
                                    Upload
                                </Button>
                            </div>
                            <div className="flex flex-1 items-center justify-center rounded-lg border border-zinc-200 bg-white">
                                <EmptyState
                                    icon={<Camera className="h-8 w-8 text-zinc-400" />}
                                    title="No photos yet"
                                    description="Upload booth shots, floor plans, and moments from this show."
                                />
                            </div>
                        </div>
                    )}
                                ...
                                <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                                    <div className="rounded-lg border border-zinc-200 bg-white p-5">
                                        <div className="mb-3 flex items-center justify-between">
                                            <span className="rounded bg-orange-100 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-orange-700">
                                                Primary Note
                                            </span>
                                    ...
                                    <button
                                        ...
                                        className="group flex min-h-[160px] flex-col items-center justify-center rounded-lg border-2 border-dashed border-zinc-200 bg-white p-6 text-center transition-colors hover:border-orange-300 hover:bg-orange-50/30"
                                    >
                                        ...
                                        <p className="text-sm font-medium text-zinc-600">Add another note</p>
                                        <p className="mt-1 text-xs text-zinc-400">Keep track of updates or meeting minutes</p>
                                    </button>
                                </div>
                            ) : (
                                <div className="flex flex-1 items-center justify-center rounded-lg border border-zinc-200 bg-white">
                                    <EmptyState
                                        ...
                                        title="No notes yet"
                                        description="Add observations and follow-up items for this show."
                                    />
                                </div>
                            )}
                        </div>
